...
async def check_membership(bot: Bot, user_id: int) -> tuple[bool, list[str]]:
    ...
    for item in required:
        ...
        try:
            ...
            # Agar direct check fail ho toh skip/assume fail ya try alternative
            pass
...
async def require_private_access(message: Message, bot: Bot) -> bool:
    ...
    await message.answer(
        "⚡ <b>APEX FF PLAYER INFO BOT</b>\n"
        "━━━━━━━━━━━━━━━━━━\n\n"
        "🔐 <b>Verification Required</b>\n\n"
        "Welcome! To continue, please complete\n"
        "the quick verification below.\n\n"
        "① Join our official channel\n"
        "② Return here and tap Verify\n"
        "③ Get instant access\n\n"
        "━━━━━━━━━━━━━━━━━━\n\n"
        "🟠 <b>Status:</b> Awaiting verification\n\n"
        "<i>Tap the buttons below to continue.</i>",
...
async def perform_lookup(message: Message, uid: str, force_refresh: bool = False):
    loading = await message.reply(
        f"🔎 <b>Searching...</b> <code>{uid}</code>" if is_group(message) else f"⚡ <b>Querying Database...</b>\n\n🆔 <code>{uid}</code>",
        reply_markup=None,
    )
    try:
...
async def start_command(message: Message, bot: Bot):
    ...
    if not verified:
        await message.answer(
            "┏ 🛡️ <b>SECURE ACCESS GATEWAY</b>\n"
            "┣ ⚡ <b>Status:</b> Locked ❌\n"
            "┗━━━━━━━━━━━━━━━━━━\n\n"
            "✨ <b>Unlock Premium Bot Features!</b>\n\n"
            "To use <b>APEX DATA</b>, please join our official update channel below.\n\n"
            "👇 <i>Join the channel, then tap verify button.</i>",
            reply_markup=verify_keyboard(),
        )
        return
    ...
    await message.answer(
        f"⚡ <b>APEX FF PLAYER INFO BOT</b>\n"
        "━━━━━━━━━━━━━━━━━━━━\n\n"
        "✅ <b>VERIFIED • ACCESS UNLOCKED</b>\n\n"
        f"Hey, <b>{user_name}</b>! 👋\n"
        "Welcome to the APEX Player Intelligence Hub.\n\n"
        "━━━━━━━━━━━━━━━━━━━━\n\n"
        "🔎 <b>Player Lookup</b>\n"
        "<i>Detailed profile & statistics</i>\n\n"
        "🛡️ <b>Ban Status</b>\n"
        "<i>Check current account status</i>\n\n"
        "🟢 <b>System Online</b>\n"
        "<i>Services running normally</i>\n\n"
        "━━━━━━━━━━━━━━━━━━━━\n\n"
        "👇 <i>Send a Player UID or choose an option below.</i>",
...
async def verify_join_callback(callback: CallbackQuery, bot: Bot):
    ...
    # Popup feedback animation effect via Telegram notification popup
    ...
    await callback.answer("✅ Verification Successful! Access Granted.", show_alert=False)
